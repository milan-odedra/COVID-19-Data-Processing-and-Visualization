...
#     ax[1].plot(Seconds,plot["Confirmed"],label="Confirmed")
#     ax[1].plot(Seconds,plot["Deaths"],label="Deaths")
#     ax[1].plot(Seconds,plot["Recovered"],label="Recovered")
...
ax[1].set_xlabel("Dates")
ax[1].set_ylabel("Number of people")
ax[1].plot(plot["Seconds"],plot["Confirmed"],label="Confirmed")
ax[1].plot(plot["Seconds"],plot["Deaths"],label="Deaths")
ax[1].plot(plot["Seconds"],plot["Recovered"],label="Recovered")
###Incase I want to re-add all of the rest of the plots.###
# ax[1].plot(Seconds,Active,label="Active")
# ax[1].plot(Seconds,newCases,label="New Cases")
# ax[1].plot(Seconds,newDeaths,label="New Deaths")

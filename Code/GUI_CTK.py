...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # create labelDF
        self.labelDF = customtkinter.CTkLabel(self, width=100, text=f"Pandas date range of 8 values in 1 timestamp column adjacent to a numpy random float array of 8 rows and 4 columns, displayed in a Tkinter table \n {dframe}",  fg_color=("white", "gray75"), corner_radius=8)
        self.labelDF.grid(row=0, column=1, padx=(20, 0), pady=(20, 0), sticky="nsew")

        

        # create checkbox and switch frame
        self.function_buttons_grid = customtkinter.CTkFrame(self)
        self.function_buttons_grid.grid(row=1, column=1, padx=(20, 20), pady=(20, 0), sticky="nsew")
        ...
        self.sidebar_button_A.grid(row=1, column=0, padx=20, pady=10)
        ...
        self.sidebar_button_B.grid(row=2, column=0, padx=20, pady=10)
        ...
        self.sidebar_button_C.grid(row=1, column=1, padx=20, pady=10)
        ...
        self.sidebar_button_D.grid(row=2, column=1, padx=20, pady=10)

        # set default values
        self.appearance_mode_optionemenu.set("Light")
        self.scaling_optionemenu.set("100%")
        self.sidebar_frame_C.configure(state="disabled")
        #self.labelDF._text("0.0", f"Pandas date range of 8 values in 1 timestamp column adjacent to a numpy random float array of 8 rows and 4 columns, displayed in a Tkinter table \n {dframe}")
